...
export default function RefundPolicyPage() {
    ...
    return (
        <div className="bg-black text-white min-h-screen py-8 px-16 max-w-5xl mx-auto">
            ...
            {/* Main Content Block */}
            <div className="py-8">
                <h1 className="text-3xl font-bold mb-6 text-center">Our Refund Policy</h1>
                ...
                <div className="mb-8">
                    ...
                    <ul className="list-disc list-inside mb-4">
                        ...
                        <li><strong>Misrepresentation:</strong> If the digital product is significantly different from its description or if it fails to perform as advertised, you may be eligible for a refund. Evidence of misrepresentation will be required. Please contact us within <b>**7 days**</b> of delivery to report such issues.</li>
                    </ul>
                </div>
                    ...
                    <ul className="list-disc list-inside mb-4">
                        ...
                        <li><strong>Subscription Services:</strong>
                            <ul className="list-circle list-inside ml-5 mt-2">
                                <li><strong>Monthly Subscriptions:</strong> Monthly subscriptions are generally non-refundable once the service period has begun. You can cancel your subscription at any time to prevent future charges.</li>
                                <li><strong>Annual Subscriptions:</strong> For annual subscriptions, a refund may be issued for the unused portion of the subscription, minus any non-refundable setup fees or a pro-rated amount for the time already used. A cancellation fee may also apply.</li>
                            </ul>
                        </li>
                ...
                <div className="mb-8">
                    ...
                    <ul className="list-disc list-inside mb-4">
                        <li><strong>Contact Us:</strong> Send an email to <Link href="mailto:jamil.matheny@majestikmagik.com" className="underline">jamil.matheny@majestikmagik.com</Link> with your order number and a detailed explanation of why you are requesting a refund.</li>
