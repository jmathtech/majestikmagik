...
export default function CybersecurityCommitmentPage() {
  ...
  return (
    <div className="bg-black text-white min-h-screen py-8 px-16 max-w-5xl mx-auto">
      ...
      {/* Main Content Block */}
      <div className="py-8">
        <h1 className="text-3xl font-bold mb-6 text-center">Our Commitment to Your Website Security</h1>
        ...
        <div className="mb-8">
          ...
          <ul className="list-disc list-inside mb-4">
            <li><strong>Use strong, unique passwords</strong> for your account and any administrative access to your website.</li>
            <li><strong>Keep your own devices and software updated</strong> with the latest security patches.</li>
            <li><strong>Be cautious of suspicious emails, links, and attachments</strong> that could be phishing attempts or vectors for malware.</li>
            <li><strong>Educate yourself and your team</strong> on basic cybersecurity best practices to minimize the risk of human error leading to security breaches.</li>
          </ul>
        </div>
